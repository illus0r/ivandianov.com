...
cover: /assets/media/projects/broken-physarum-live.jpg
span: 3
---

# Broken Physarum: параметрически управляемая эмерджентная импровизация

![Параметрически управляемая эмерджентная импровизация](/assets/media/projects/broken-physarum-live.jpg)
