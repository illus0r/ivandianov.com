...
cover: https://ik.imagekit.io/ivandianov/videos/walbi.mp4?tr=orig-true
span: 2
---
...
![](https://ik.imagekit.io/ivandianov/projects/walbi/idea5.jpg)


Создали онлайновый редактор с несколькими визуальными стилями. Вот чёрно-белая версия реагирует на движение мыши:

<video autoplay muted loop src="https://ik.imagekit.io/ivandianov/projects/walbi/result-2mouse.mp4?tr=orig-true"></video>
{style="width: 50%"}

Перламутровая версия живёт и непрерывно меняет форму:

<video autoplay muted loop src="https://ik.imagekit.io/ivandianov/projects/walbi/result-3clusterize.mp4?tr=orig-true"></video>
{style="width: 50%"}

Любое изображение может быть «децентрализовано» с помощью нашего инструмента:

<video autoplay muted loop src="https://ik.imagekit.io/ivandianov/projects/walbi/result-5background.mp4?tr=orig-true"></video>
{style="width: 50%"}

Агенты могут становиться символами и зашифровывать любые послания:

<video autoplay muted loop src="https://ik.imagekit.io/ivandianov/projects/walbi/result-4text.mp4?tr=orig-true"></video>
...
<video autoplay muted loop src="https://ik.imagekit.io/ivandianov/projects/walbi/site.mp4?tr=orig-true"></video>
{style="width: 50%"}
...
<video autoplay muted loop src="https://ik.imagekit.io/ivandianov/projects/walbi/cat.mp4?tr=orig-true"></video>
{style="width: 50%"}
