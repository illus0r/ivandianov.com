...
cover: https://media.ivandianov.com/videos/walbi.mp4?tr=orig-true
span: 2
---
...
![](https://media.ivandianov.com/projects/walbi/idea5.jpg)

We created an online editor with several visual styles. Here is the black-and-white version that reacts to mouse movement:

<video autoplay muted loop src="https://media.ivandianov.com/projects/walbi/result-2mouse.mp4?tr=orig-true"></video>
{style="width: 50%"}

The pearlescent version continuously changes its shape:

<video autoplay muted loop src="https://media.ivandianov.com/projects/walbi/result-3clusterize.mp4?tr=orig-true"></video>
{style="width: 50%"}

Any image can be "decentralized" using our tool:

<video autoplay muted loop src="https://media.ivandianov.com/projects/walbi/result-5background.mp4?tr=orig-true"></video>
{style="width: 50%"}

Agents can become symbols and encrypt any messages:

<video autoplay muted loop src="https://media.ivandianov.com/projects/walbi/result-4text.mp4?tr=orig-true"></video>
...
<video autoplay muted loop src="https://media.ivandianov.com/projects/walbi/site.mp4?tr=orig-true"></video>
{style="width: 50%"}
...
<video autoplay muted loop src="https://media.ivandianov.com/projects/walbi/cat.mp4?tr=orig-true"></video>
{style="width: 50%"}
