...
> Иван разрабатывает интерактивные веб-приложения, которые позволяют упровлять сложными системами, менять их параметры и наблюдать за появляющимися паттернами. Художник экспериментирует с мультиагентными системами, клеточными автоматами и генеративными грамматиками.
