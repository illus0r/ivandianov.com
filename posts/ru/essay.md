...
В визуализации данных есть такое понятие как indexical visualisation, это когда явление само визуализирует себя. Например, дым в воздухе  показывает своё движение. Генеративный арт — похожее явление: код сам визуализирует свой алгоритм и создавая графические артифакты, выявляет свою природу.
...
Я работаю в трёх направлениях: арт, коммерческие заказы (I collaborate with designers and agencies) и образование. Мне важно поделиться со студентами вайбом и азартом, который вызвает у меня программирование.
